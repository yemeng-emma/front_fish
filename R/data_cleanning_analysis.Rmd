...
```{r}
## save picture for slides

direct_effects <- p2 | p1

ggsave(
  filename = here("output","direct_effects_slide.png"),
  plot = direct_effects,
  width = 12,        # inches (fits well on a 16:9 slide)
  height = 7,    # 10 * 9 / 16 keeps 16:9 ratio
